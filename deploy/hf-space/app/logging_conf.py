...
# Contesto per-thread/async: gli id del job e del video in lavorazione.
...
@contextmanager
def log_context(job_id: str | None = None, video_id: str | None = None) -> Iterator[None]:
    """Associa job_id/video_id a tutti i log emessi nel blocco.

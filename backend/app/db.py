...
def _mini_migrations() -> None:
    ...
    stmts = [
        ...
        # size_bytes: int32 -> int64 (overflow su Postgres per file >= ~2.1 GB).
        # DO-block idempotente: converte solo se la colonna e' ancora 'integer'
        # (niente rewrite inutile a ogni avvio). Su SQLite la sintassi non e'
        # supportata -> eccezione -> pass (ed e' corretto cosi': l'INTEGER di
        # SQLite e' gia' a 64 bit).
        """DO $$ BEGIN
